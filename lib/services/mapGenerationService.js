...
function generateTerrainDescription(terrain) {
  ...
  if (terrainData && terrainData.adjectives && terrainData.modifiers) {
    ...
    return `${adjective} ${terrain} terrain with ${modifier1} and ${finalModifier2}, perfect for exploration and adventure.`;
  } else {
    return `A ${terrain} terrain map perfect for tabletop adventures.`;
  }
}
