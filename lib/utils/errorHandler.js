...
function createErrorHandler(options = {}) {
  const { includeStack = process.env.NODE_ENV === 'development', logError = true } = options;
...
const createError = {
  ...
  rateLimit: (message = null) => new AppError(ERROR_TYPES.RATE_LIMIT_ERROR, message),

  authentication: (message = null) => new AppError(ERROR_TYPES.AUTHENTICATION_ERROR, message),

  authorization: (message = null) => new AppError(ERROR_TYPES.AUTHORIZATION_ERROR, message),
  ...
  notFound: (message = null) => new AppError(ERROR_TYPES.NOT_FOUND_ERROR, message),
