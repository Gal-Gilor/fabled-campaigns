...
class ImagenService {
  ...
  async _initialize() {
    ...
    try {
      ...
      // or using environment variable approach
      const fs = require('fs');
      const path = require('path');
      const os = require('os');
      
      // Create temporary credentials file
      const credentialsPath = path.join(os.tmpdir(), `service-account-${Date.now()}.json`);
      ...
      // Clean up temporary file after initialization
      try {
