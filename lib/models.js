 ...
 * @param {string} mode - 'quick' or 'detailed' (currently unused - both use same model)
 * @returns {string} The appropriate model name
 */
const getImageModel = (mode) => {
  // Use the same model for both modes since imagen-3.0-fast-generate-001 
  // is only available in Vertex AI, not in Gemini Developer API
