...
const negativePrompt = 'no grid, gridless, no overlay, distorted grid, skewed grid, warped grid, text, labels, legends, characters, people, miniatures, minis, figures, frontal view, front view, side view, bottom-up, close-up, soft focus, extreme close-up, zoomed-in, zoom in, low quality, low resolution, bad quality, bad resolution';
